...
export const partners: Partner[] = [
  ...
  { slug: "parceiro-11", name: "Parceiro", specialty: "Especialidade a definir",
    about: "Descrição do parceiro a ser preenchida.",
    capabilities: ["Capacidade 1", "Capacidade 2", "Capacidade 3"],
    whenToUse: "Quando indicar este parceiro.",
    benefits: ["Benefício 1", "Benefício 2"] },
  { slug: "parceiro-12", name: "Parceiro", specialty: "Especialidade a definir",
    about: "Descrição do parceiro a ser preenchida.",
    capabilities: ["Capacidade 1", "Capacidade 2", "Capacidade 3"],
    whenToUse: "Quando indicar este parceiro.",
    benefits: ["Benefício 1", "Benefício 2"] },
  { slug: "parceiro-13", name: "Parceiro", specialty: "Especialidade a definir",
    about: "Descrição do parceiro a ser preenchida.",
    capabilities: ["Capacidade 1", "Capacidade 2", "Capacidade 3"],
    whenToUse: "Quando indicar este parceiro.",
    benefits: ["Benefício 1", "Benefício 2"] },
  { slug: "parceiro-14", name: "Parceiro", specialty: "Especialidade a definir",
    about: "Descrição do parceiro a ser preenchida.",
    capabilities: ["Capacidade 1", "Capacidade 2", "Capacidade 3"],
    whenToUse: "Quando indicar este parceiro.",
    benefits: ["Benefício 1", "Benefício 2"] },
  { slug: "parceiro-15", name: "Parceiro", specialty: "Especialidade a definir",
    about: "Descrição do parceiro a ser preenchida.",
    capabilities: ["Capacidade 1", "Capacidade 2", "Capacidade 3"],
    whenToUse: "Quando indicar este parceiro.",
    benefits: ["Benefício 1", "Benefício 2"] },

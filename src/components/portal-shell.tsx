                    ...
                    <li key={item.to}>
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          active
                            ? sidebarDark
                              ? "bg-gradient-to-r from-primary/75 via-primary/40 to-transparent text-[var(--sidebar-executive-foreground)] shadow-[0_0_24px_-4px_var(--primary)] ring-1 ring-primary/90"
